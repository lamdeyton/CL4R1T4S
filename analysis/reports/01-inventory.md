...
| 文件 | 行数 | 字节 | 日期 | 模型 | 工具数 | 显著特征 |
|---|---|---|---|---|---|---|
| LEO_Aug-31-2025 | 43 | 2971 | 2025-08-31 | Leo (Llama 3.1 8B) | 0 | 5 数据容器标签防注入；披露底层模型；R34 G118：file_date/content_date 相差1天（外泄日 2025-08-31 vs 系统提示词预设日 2025-09-01，66文件中唯一file_date≠content_date样本） |
